...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getInputParameter = void 0;
 ...
 */
const readMdFiles = (dirPath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const fileContentsArray = yield Promise.all(mdFiles.map((file) => __awaiter(void 0, void 0, void 0, function* () {
            const filePath = (0, path_1.join)(dirPath, file);
            const fileContents = yield (0, promises_1.readFile)(filePath, "utf8");
            return { [file]: fileContents };
        })));
        return fileContentsArray;
    }
    catch (error) {
        throw new Error(`Error reading .md files from ${dirPath}: ${error.message}`);
    }
});
 ...
 */
const outputMarkdown = (data, outputFileName) => {
    /**
     ...
     */
    const writeCompletionCallback = (err) => {
        if (err) {
            console.error(`Failed to write to ${outputFileName}:`, err);
        }
        else {
            console.log(`Updated data has been written to ${outputFileName} successfully.`);
        }
    };
    (0, fs_1.writeFile)(outputFileName, data, "utf8", writeCompletionCallback);
};
...
const file_1 = __nccwpck_require__(370);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        // Get input parameter.
        const { templatePath, srcDir, destFile } = (0, action_1.getInputParameter)();
        // Get template file.
